        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="border-b border-gray-200 pb-4 mb-4">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-lg font-semibold text-gray-800">
                  Mi apartamento en Valencia
                </h3>
                <p className="text-gray-500 text-sm mt-1">Apartamento</p>
              ...
              <span className="text-green-600 font-bold">€2400 este mes</span>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Casa</p>
                <p className="text-gray-500 text-sm mt-1 flex items-center space-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
              ...
              <span className="text-green-600 font-bold">€1800 este mes</span>
            </div>
          </div>
